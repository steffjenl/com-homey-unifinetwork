...
class UniFiWiredDriver extends Homey.Driver {
    /**
     * onInit is called when the driver is initialized.
     */
    async onInit() {
        Homey.app.debug('UniFiWiredDriver Driver has been initialized');
    }
    ...
    onPair(socket) {
        ...
        socket.on('list_devices', async (data, callback) => {
            callback(null, Object.values(await Homey.app.api.getWiredClients()).map(client => {
                    return {
...
module.exports = UniFiWiredDriver;
